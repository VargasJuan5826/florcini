    ...
    <div class="flora">
      <div id="pdf-confirmation">
        <div style="padding:20px;text-align:center">
          <img src="{assets.url(img_name)}" alt="plancito"
               style="width:90px;height:auto;border-radius:12px;margin:0 auto 14px">
          <div style="font-size:20px;font-weight:900;color:#7c3aed;margin:0 0 4px">
            🎮 Ticket de Plancito: Flora
          </div>
          <div style="font-size:10px;color:#6b7280;margin:0 0 18px">
            // misión_coordinada_v1.0 · Rango: Conocido 1
          </div>
        </div>
        <div style="padding:0 20px 20px">
          ...
          <div style="font-size:10px;color:#6b7280;text-align:center;line-height:1.6;margin:0">
            ¡Coordinamos los detalles por chat! 😎<br>
            <span style="font-size:8px">// generado por matchmaking_casual.lobby</span>
          </div>
        </div>
      </div>
    </div>
...
# El posicionamiento fuera de pantalla de la tarjeta está en floraapp/theme.py.
